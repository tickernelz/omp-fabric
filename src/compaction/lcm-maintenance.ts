...
export class LcmMaintenance {
  ...
  private validateShrink(text: string, inputBytes?: number): void { if (inputBytes !== undefined && utf8Bytes(text) >= inputBytes) throw new Error("summary does not shrink its input"); }
