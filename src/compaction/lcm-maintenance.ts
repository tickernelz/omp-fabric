...
export class LcmMaintenance {
  ...
  /**
   * Scoped by the live source set when one is given, so a fork keeps the summaries
   * built over the entries it inherited; drops a condensed child and a contained node.
   */
