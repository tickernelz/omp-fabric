...
describe("LCM ledger", () => {
  ...
  it("purges the deleted project's quarantined rows and reports an honest remaining count", () => {
    ...
    expect(Object.keys(manifest.remainingByTable).sort()).toEqual(["frontiers", "maintenance_jobs", "maintenance_usage", "orphaned_rows", "project_aliases", "projects", "raw_entries", "raw_entries_fts", "repair_ladder", "sessions", "summary_edges", "summary_node_revisions", "summary_nodes"]);
