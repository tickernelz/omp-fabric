...
describe("LCM memory retrieval", () => {
  ...
  it("applies regex and phrase query modes to summary text", () => {
    ...
    const nodes: LcmSummaryNode[] = [
      { nodeId: "n1", projectKey: ledger.project.key, sessionId: "s", sourceHash: "h1", state: "ready", text: "ticket 4821 resolved", children: [], sources: [], createdAt: 2 },
      { nodeId: "n2", projectKey: ledger.project.key, sessionId: "s", sourceHash: "h2", state: "ready", text: "ticket unresolved backlog", children: [], sources: [], createdAt: 1 },
    ];
    const adapter = new LcmMemoryAdapter({
      ledger: capability(ledger),
      currentSessionId: "s",
